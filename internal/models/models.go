...
// PlayerOwnershipDetail represents one player's full summary in the unified player-ownership document.
type PlayerOwnershipDetail struct {
	PlayerID     string                        `yaml:"player_id"`
	PlayerName   string                        `yaml:"player_name"`
	CurrentCount int                           `yaml:"current_count"`
	History      []PlayerOwnershipHistoryEntry `yaml:"history,omitempty"`
}

// PlayerOwnershipDoc is the top-level structure for player-ownership.yaml.
type PlayerOwnershipDoc struct {
	Season      string                  `yaml:"season"`
	GeneratedAt string                  `yaml:"generated_at,omitempty"`
	Players     []PlayerOwnershipDetail `yaml:"players"`
}
