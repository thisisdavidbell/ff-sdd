...
func BuildHTML(current map[string]models.PlayerOwnershipRecord, history map[string][]models.PlayerOwnershipHistoryEntry, summaries []models.ManagerChangeSummary) (string, error) {
	...
	b.WriteString("<html><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><title>Guy Sports Data</title>\n")
	...
	b.WriteString(fmt.Sprintf("<header class=\"mobile-header\"><div><h1 class=\"mobile-title\">Guy Sports Data</h1><p class=\"mobile-generated\">Report generated: %s</p></div><button class=\"menu-button\" type=\"button\" aria-label=\"Open navigation menu\" aria-controls=\"report-nav-content\" aria-expanded=\"false\"><span class=\"hamburger\"></span></button></header>\n", generatedAt))
	b.WriteString(fmt.Sprintf("<header class=\"report-header\"><div><h1>Guy Sports Data</h1><p class=\"report-generated\">Report generated: %s</p></div></header>\n", generatedAt))
	b.WriteString("<nav class=\"report-nav\" aria-label=\"Report sections\"><div id=\"report-nav-content\" class=\"report-nav-content\"><div class=\"nav-group\"><span class=\"nav-label\">Statistics</span><a href=\"#player-ownership\">Player ownership</a><a href=\"#team-changes\">Team changes</a></div><div class=\"nav-group\"><span class=\"nav-label\">Trends</span><a href=\"#historical-trends\">Historical trends</a></div><div class=\"nav-settings\"><span class=\"nav-label\">Settings</span><button class=\"theme-toggle\" type=\"button\" aria-label=\"Toggle dark mode\" title=\"Toggle dark mode\">Dark mode</button></div></div></nav>\n")
