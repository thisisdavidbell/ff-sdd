...
func BuildHTML(current map[string]models.PlayerOwnershipRecord, history map[string][]models.PlayerOwnershipHistoryEntry, summaries []models.ManagerChangeSummary) (string, error) {
	...
	b.WriteString(fmt.Sprintf("<header class=\"mobile-header\"><div class=\"report-identity\"><img class=\"report-logo\" src=\"assets/ffd-logo.svg\" alt=\"FFD\"><div><h1 class=\"mobile-title\">Fantasy Football Data</h1><p class=\"mobile-generated\">Updated: %s</p></div></div><button class=\"menu-button\" type=\"button\" aria-label=\"Open navigation menu\" aria-controls=\"report-nav-content\" aria-expanded=\"false\"><span class=\"hamburger\"></span></button></header>\n", generatedAt))
	b.WriteString(fmt.Sprintf("<header class=\"report-header\"><div><h1>Fantasy Football Data</h1><p class=\"report-generated\">Updated: %s</p></div></header>\n", generatedAt))
